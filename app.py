...
async def GetCSV(request: Request):
    ...
    export_headers = {"Content-Disposition": "attachment; filename={file_name}.csv".format(file_name=adress)}
    return StreamingResponse(writer, headers=export_headers, media_type=export_media_type)
